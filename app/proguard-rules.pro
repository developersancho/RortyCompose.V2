...
-keep class com.developersancho.rortycompose.data.model.** { *; }
-keepclasseswithmembers class com.developersancho.rortycompose.data.model.** { *; }
#-keep class com.developersancho.rortycompose.** { *; }
#-keepclasseswithmembers class com.developersancho.rortycompose.** { *; }